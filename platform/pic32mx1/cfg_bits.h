...
// NOTE: configuration bits calibrated for 8 MHz internal clock
...
#pragma config POSCMOD = OFF        // Primary Oscillator Selection
                                    // HS   High Speed oscillator
                                    // EC   External Clock oscillator
                                    // XT   Crystal oscillator
                                    // OFF  Disabled

#pragma config FPLLIDIV = DIV_2     // PLL Input Divide by 1, 2, 3, 4, 5, 6, 10, 12
#pragma config FPLLMUL = MUL_24     // PLL Multiply by 15, 16, 17, 18, 19, 20, 21, 24
...
#pragma config IESO = OFF           // Internal External Switchover (Two-Speed Start-up) ON or OFF
...
#pragma config ICESEL = ICS_PGx2    // Programming port selection

//#pragma config UPLLIDIV = DIV_5     // USB PLL Input Divide by 1, 2, 3, 4, 5, 6, 10, 12
//#pragma config UPLLEN = OFF         // USB PLL ON or OFF
